...
async def text_to_edit_entered(message: Message, state: FSMContext, content_history_repo, ai_api_repo, gigachat_service):
    ...
    # Редактируем текст
    result = await gigachat_service.edit_text(
        text=message.text,
